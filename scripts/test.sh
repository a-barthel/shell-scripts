...
git push
#test1-1
echo qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq > in
./pwcheck.sh in > out1-1
line=$(head -n1 out1-1)
...
#test2-2
echo aBcDeFgHiJkLmNoPqRsTuVwXyZaBcDe > in
./pwcheck.sh in > out2-2
line=$(head -n1 out2-2)
...
#test3-2
echo aBcDeFg94JkLmNo8qRsTuVwXyZaBcD2 > in
./pwcheck.sh in > out3-2
line=$(head -n1 out3-2)
...
#test6-1
echo aBcDeFgHiJkawfa > in
./pwcheck.sh in > out6-1
line=$(head -n1 out6-1)
if [ "$line" == "Password Score: 17" ] ; then
	echo "Test6-1 Passed";
	let score=score+2;
...
#test6-2
echo abcdefghijkl > in
./pwcheck.sh in > out6-2
line=$(head -n1 out6-2)
...
#test8-2
echo ab12345f2456gD986f2e35a6f > in
./pwcheck.sh in > out8-2
line=$(head -n1 out8-2)
...
#test9-1
echo Exon#Mobi@Le21 > in
./pwcheck.sh in > out9-1
line=$(head -n1 out9-1)
...
#test9-2
echo 123456789abcdef@gDWSS@Aw4 > in
./pwcheck.sh in > out9-2
line=$(head -n1 out9-2)
